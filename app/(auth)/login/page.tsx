  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-zinc-400 mt-2">Sign in to your Zynk account</p>
      </div>
      ...
      <GlassCard>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-[12px] font-medium transition-colors mb-4"
        >
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-[#0a0a0a] text-zinc-500">Or continue with email</span>
          </div>
        </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center"><p className="text-white">Loading...</p></div>}>
      <LoginForm />
    </Suspense>
  )
}
